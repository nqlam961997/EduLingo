...
| `AI_PROVIDER` | `local` | `local` = Ollama, `gemini` = Google Gemini API |
| `LOCAL_AI_URL` | `http://localhost:8000` | Python backend URL |
| `GEMINI_API_KEY` | *(key demo)* | Chỉ cần khi `AI_PROVIDER=gemini` |
